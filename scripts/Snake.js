define(["SnakeWorldOptions", "Cell", "wrap"], function(SnakeWorldOptions, Cell, wrap) {
    ...
    Snake.prototype.getNewHead = function() {
        ...
        do {
            ...
            if ((Math.random() * 10) < SnakeWorldOptions.turnChance && !foodSeen) {
                this.randomTurn();
            }
        ...
        return new Cell(
            wrap(nx, (this.game.width() / SnakeWorldOptions.getCellWidth())),
            wrap(ny, (this.game.height() / SnakeWorldOptions.getCellWidth())));
